    ...
    <div class="popup-modal-content rounded-xl">
      ...
      <div class="row">
        <div class="col-md-12 mx-auto">
          <h3 class="text-left mb-4 font-poppins font-semibold md:text-[1.062rem] text-[0.90rem] text-routersTextColor">Add Media</h3>
          <form>
            <div class="mb-1">
              <label
                for="small-input"
          ...
          /> New Category?
              ...
              <addCategoryForm v-if="showCategoryModal" @close="closeCategoryModal()"></addCategoryForm>
              <select
                class="text-[14px] w-full h-[2.688rem] border-[0.063rem] bg-white rounded-[0.625rem] px-3 py-2 border-textFieldBorder"
                id="realm"
                v-model="category"
