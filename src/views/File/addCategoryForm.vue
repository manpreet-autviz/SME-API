<template>
    <div class="popup-modal">
      <div class="popup-modal-content rounded-xl">
        <button   @click="$emit('close')" class="float-right"><img
        ...
        <div class="row">
          <div class="col-md-12 mx-auto">
            <h3 class="text-left mb-4 font-poppins font-semibold md:text-[1.062rem] text-[0.90rem] text-routersTextColor">Add Media Category</h3>
            <form >
                <div class="mb-2">
                    <label
                for="small-input"
