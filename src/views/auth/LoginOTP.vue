      ...
      <div class="flex flex-col justify-center items-center h-full relative">
        <div class="max-form w-full lg:py-0 py-10">
          ...
          <div class="bg-white rounded-[0.432rem] lg:p-0 p-4">
            <h1 class="font-['poppins'] font-bold text-[26px] text-center">OTP Sent!</h1>
            ...
            <form class="mt-10">
              <TextField name="otp"
                ...
                placeholder="OTP" type="text" v-model="v$.otp.$model" :showErrors="v$.otp.$errors.length ? true : false"
                :errors="v$.otp.$errors" />
              <div class="w-full flex lg:justify-end justify-start items-center -mt-3 mb-6">
                <button type="button" @click="handleResend">
                  <span class="font-poppins font-medium text-[0.778rem] lg:text-[#4D99FF] text-[#4E8D6E]">Resend
                    OTP</span>
                </button>
              </div>
