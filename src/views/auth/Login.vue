      ...
      <div class="flex flex-col justify-center items-center h-full relative">
        <div class="max-form w-full lg:py-0 py-10">
          ...
          <div class="bg-white rounded-[0.432rem] lg:p-0 p-4">
            <h1 class="font-['poppins'] font-bold text-[26px] text-center">Sign In</h1>
            <h1
            ...
            <form class="mt-10">
              ...
              <div class="w-full flex lg:justify-end justify-start items-center -mt-3 mb-6">
                <button type="button" @click="handleForgotPassword">
                  <span
                    class="text-success font-poppins font-medium text-[0.778rem] lg:text-[#4D99FF] text-[#4E8D6E]">Forgot
                    Password?</span>
                </button>
              </div>
              ...
              <div class="w-full flex justify-center items-center my-6">
                <span class="font-poppins font-normal text-[#838282] text-[12.9px]">Don't have an account yet?
                  <button type="button" class="text-success font-semibold lg:text-[#4D99FF] text-[#4E8D6E]"
                    @click="handleSignup">
                    Sign up
                  </button></span>
              </div>
